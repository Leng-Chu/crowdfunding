...
\AtBeginEnvironment{tabularx}{\renewcommand{\arraystretch}{1.2}}
\AtBeginEnvironment{longtable}{\renewcommand{\arraystretch}{1.2}}
\newcommand{\plainitemlabel}[1]{#1\hspace{0.5em}}
\setlist[enumerate,1]{
    label=(\arabic*),
    labelindent=0pt,
    leftmargin=0pt,
    ...
    parsep=0pt,
    itemsep=0pt,
    before=\let\makelabel\plainitemlabel
}
\setlist[itemize,1]{
    label=\textbullet,
    labelindent=2em,
...
\geometry{a4paper,left = 3.5cm,right = 3cm,top = 3.0cm,bottom= 4cm}
